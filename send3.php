                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="course-single.php">Single Course (with image)</a></li>
                                <li><a href="course-single-2.php">Single Course (with video)</a></li>              
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="news-single.php">Single News (with image)</a></li>   
                                <li><a href="news-single-2.php">Single News (with video)</a></li>          
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="job-single.php">Single Job</a></li>
                                <li><a href="gallery.php">Gallery (3 columns)</a></li>
                                <li><a href="gallery-2.php">Gallery (4 columns)</a></li>
                                <li><a href="gallery-3.php">Gallery (2 columns)</a></li>
                                <li><a href="gallery-4.php">Gallery (with sidebar)</a></li>
                                <li><a href="gallery-album.php">Single Gallery</a></li>
                                <li><a href="gallery-album-2.php">Single Gallery (with sidebar)</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="typography.php"><i class="fa fa-file-text"></i> Typography</a></li>
                                <li><a href="tables.php"><i class="fa fa-table"></i> Tables</a></li>
                                <li><a href="buttons.php"><i class="fa fa-star"></i> Buttons</a></li>
                                <li><a href="components.php"><i class="fa fa-rocket"></i> Components</a></li> 
                                <li><a href="icons.php"><i class="fa fa-heart"></i> Icons</a></li>                                                 
                            </ul>
                        </li><!--//dropdown-->
                    ...
                    <div class="row">
                        <article class="contact-form col-md-8 col-sm-7  page-row">                            
                            ...
                            <?php
                                ...
                                $mailer->Username = 'skitenglish@gmail.com';  // Gmailのアカウント名
                                $mailer->Password = 'onetalentoneskit';  // Gmailのパスワード
                                $mailer->From     = 'skitenglish@gmail.com';  // Fromのメールアドレス
                                $mailer->FromName = mb_encode_mimeheader(mb_convert_encoding("Skit Language School","JIS","UTF-8"));
                                $mailer->Subject  = mb_encode_mimeheader(mb_convert_encoding("体験申込受付","JIS","UTF-8"));
                                $mailer->Body     = mb_convert_encoding("名前：" . $_POST["name"] . "\n性別：" . $_POST["sex"] . "\nメールアドレス：" . $_POST["email"] . "\n電話番号：" . $_POST["phone"] . "\n言語：" . $_POST["lang"] . "\nトピック：" . $_POST["want"] . "\n内容：" . $_POST["content"] . "\n文法の理解度：" . $_POST["level"] . "\n希望日：" . $_POST["day"] . "\n希望時間：" . $_POST["time"] . "\nご友人：" . $_POST["frined"] . "\nご質問：" . $_POST["question"],"JIS","UTF-8");
                                $mailer->AddAddress('skitenglish@gmail.com'); // 宛先
