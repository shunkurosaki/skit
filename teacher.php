...
<head>
    ...
    <meta itemprop="name" content="教師">
    <meta property="og:url" content="http://www.skit.mobi/teacher.php">
    <meta itemprop="url" content="http://www.skit.mobi/teacher.php">
                    ...
                    <div class="row page-row">
                        <div class="news-wrapper col-md-8 col-sm-7">
                            <article class="course-item">
                                ...
                                <div class="row page-row" >
                                    <figure class="thumb col-md-3 col-sm-4 col-xs-6">
                                        <img class="img-responsive" src="assets/images/teacher/teacher-1.jpg" alt="" />
                                    </figure>
                                    <div class="details col-md-9 col-sm-8 col-xs-6">
                                        <h3 class="title">リュウ トン</h3>
                                        <h4>英語、中国語</h4>
                                        <p>Hi, My name is Tong, from China. I spend a lot of time watching movies, I am also a big fan of classic novels. One thing I would like to share with you is my life motto — be flexible and keep attempting, life is more enjoyable than you think.<br><br>
                                        你们好，我叫彤，来自中国西安。我最大的爱好是看电影，同时我也非常喜欢看经典文学类的小说。我最想分享给你们的话是：做一个灵活的人，并且持续尝试新事物，生活可以变得比你想象的更加多姿多彩。</p>
                                    </div>
                                </div>
                                <div class="row page-row" >
                                    <figure class="thumb col-md-3 col-sm-4 col-xs-6">
